...
This repository provides the implementation of the _soft-boundary Deep SVDD_ and _one-class Deep SVDD_ method we used
...
This runs a _one-class Deep SVDD_ (`hard_margin = 1` and `block_coordinate = 0`) experiment with pre-training routine
...
The _pl-cnn_ repository is an implementation of the paper
